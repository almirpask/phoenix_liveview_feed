defmodule PhoenixFeedWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PhoenixFeedWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PhoenixFeedWeb.Gettext, "errors", msg, opts)
    end
  end
